...
class Level:
    def __init__(self, level_data, surface):
        ...
        self.world_shift = 0
        self.current_x = 0  # for solving rectangle collision problem
    ...
    def create_landing_dust(self):
        if not self.player_on_ground and self.player.sprite.touching_ground and not self.dust_sprite.sprites():
            ...
            fall_dust_particle = DustEffect(self.player.sprite.rect.midbottom - offset,'land')
    ...
    def create_jump_particles(self,pos):
        if self.player.sprite.facing_right:
            ...
            pos += pygame.math.Vector2(10, -5)
        jump_particle_sprite = DustEffect(pos,'jump')
